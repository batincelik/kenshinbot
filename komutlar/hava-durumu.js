...
const api = 'http://api.openweathermap.org/data/2.5/weather?q=' + args[0] + '&appid=9085d68629e6d57983a2c93a8fa2cd66';
 ...
 if (mesaj.length < 1) return message.channel.sendEmbed(new discord.RichEmbed().setDescription(':X: Şehir belirtmelisiniz.').setColor('RED'));
 try {
...
return text;
    ...
    .setColor('RED')
    .setDescription(':X: Bir hata ile karşılaştık : \n`' + e.message + '`')
...
exports.help = {
  name: 'hava-durumu',
  description: 'İstediğiniz şehirin hava durumunu gösterir.',
