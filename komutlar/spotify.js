...
module.exports.run = async (bot, message, args) => {
    ...
    if (user.presence.game.name === 'Spotify' && user.presence.game.type === 1) {
        try {
            ...
            const embed = new Discord.RichEmbed()
                ...
                .setFooter(`Everest Spotify Sistemi ${message.author.username} tarafından istendi.`, "https://cdn.discordapp.com/emojis/515260605347659777.png?v=1")
                .setDescription(`
